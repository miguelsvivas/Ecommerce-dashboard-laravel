	...
	<div class="panel shadow">
		<div class="header">
			...
			<li>
				...
				<ul class="shadow">
					<li><a href="{{ url('/admin/products/1')}}"><i class="fas fa-globe-americas"></i>Publicos</a></li>
					...
					<li><a href="{{ url('/admin/products/1')}}"><i class="fas fa-list-ul"></i>Todos</a></li>
			...
			<div class="form_search" id="form_search">
				...
				{!!  Form::open(['url' => '/admin/product/search'])  !!}
					...
					<div class="row">
						...
						{!! Form::select('filter',['0'=>'Nombre del producto','1'=>'codigo'],'0',['class' => 'form-control']) !!}
		...
		<table class="table table-striped mtop16">
			...
			<tbody>
				...
				<td width="64">
					...
					<img src="{{url('/uploads/'.$p->file_path.'/t_'.$p->image)}}" width="64"></a></td>
				<td>{{$p->name}} @if($p->status == "0") <i class="fas fa-eraser" data-toggle="tooltip" data-placement="top" title="Estado: borrador"
					></i> @endif
				</td>
				<td>{{$p->cat->name}}</td>
				<td>{{$p->price}}</td>
				<td>
					 ...
					 <div class="opts">
					 		@if(kvfj(Auth::user()->permissions, 'product_edit'));
                                ...
                                <a href="#" data-path="admin/product" data-action="delete"  data-object="{{ $p->id }}" data-toggle="tooltip" data-placement="top" title="Eliminar" class="btn-deleted"><i class="fas fa-trash-alt"></i>

                                </a>
                                @else
                          
                                <a href="{{url('/admin/product/'.$p->id.'/restore')}}"  data-path="admin/product" data-action="restore" data-object="{{ $p->id }}" data-toggle="tooltip" data-placement="top" title="Restaurar" class="btn-deleted"><i class="fas fa-trash-restore"></i>
                                  @endif
                                  @endif
                                </div>
